                ...
                <form onSubmit={handleSubmit} className="bg-white shadow-2xl rounded-2xl p-6 sm:p-10 border border-slate-200">
                    ...
                    <div className="space-y-6 sm:space-y-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            ...
                            <div className="flex-1">
                                <label htmlFor="ano_publicacao" className="block text-sm font-semibold text-slate-700 mb-2">Ano de Publicação</label>
                                <input
                                    type="text"
                                    name="ano_publicacao"
                                    id="ano_publicacao"
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            ...
                            <div className="flex-1">
                                <label htmlFor="quant_total" className="block text-sm font-semibold text-slate-700 mb-2">Quantidade Total</label>
                                <input
                                    type="number"
                                    name="quant_total"
                                    id="quant_total"
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            <div className="flex-1">
                                <label htmlFor="quant_disponivel" className="block text-sm font-semibold text-slate-700 mb-2">Quantidade Disponível</label>
                                <input
                                    type="number"
                            ...
                            <div className="flex-1">
                                <label htmlFor="quant_aquisicao" className="block text-sm font-semibold text-slate-700 mb-2">Quantidade de Aquisição</label>
                                <input
                                    type="number"
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            <div className="flex-1">
                                <label htmlFor="valor_aquisicao" className="block text-sm font-semibold text-slate-700 mb-2">Valor de Aquisição</label>
                                <input
                                    type="number"
