...
function FormEmprestimo() {
    ...
    const [formData, setFormData] = useState<FormEmprestimoDTO>({
        aluno: {
            id_aluno: 0
        },
        livro: {
                    ...
                    <div className="space-y-6 sm:space-y-8">
                        <div className="flex flex-col sm:flex-row gap-6">
                            <div className="flex-1">
                                <label htmlFor="id_aluno" className="block text-sm font-semibold text-slate-700 mb-2">Aluno</label>
                                <select
                                    name="id_aluno"
                                    id="id_aluno"
                            ...
                            <div className="flex-1">
                                <label htmlFor="id_livro" className="block text-sm font-semibold text-slate-700 mb-2">Livro</label>
                                <select
                                    name="id_livro"
                                    id="id_livro"
                                ...
                                >
                                    <option value="" disabled>Selecione...</option>
                                    {livros.length === 0 ? (
                                        <option value="" disabled>Nenhum livro encontrado</option>
                                    ) : (
                                        livros.map(livro => (
                        ...
                        <div className="flex flex-col sm:flex-row gap-6">
                            <div className="flex-1">
                                <label htmlFor="data_emprestimo" className="block text-sm font-semibold text-slate-700 mb-2">Data do Empréstimo</label>
                                <input
                                    type="date"
