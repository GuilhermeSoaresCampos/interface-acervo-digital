        ...
        if (confirmar) {
            try {
                ...
                if (sucesso) {
                    ...
                    setLivros(livros.filter(l => l.id_livro !== id_livro));
                } else {
                    ...
                    <table className="table-auto w-full border-collapse text-xs sm:text-sm md:text-base">
                        <thead className="bg-slate-700 sticky top-0 z-10 shadow-sm">
                            <tr>
                                ...
                                <th className="border-b border-slate-600 text-white p-3 md:p-4 hidden lg:table-cell text-left">Autor</th>
                                <th className="border-b border-slate-600 text-white p-3 md:p-4 hidden lg:table-cell text-left">Disponível</th>
                        ...
                        <tbody className="divide-y divide-slate-200">
                            {currentLivros && currentLivros.length > 0 ? (
                                currentLivros.map((livro) => (
                                    <tr className="text-center md:text-left transition-colors hover:bg-slate-50 group" key={livro.id_livro ?? livro.titulo}>
                                        ...
                                        <td className="p-3 md:p-4 hidden lg:table-cell text-slate-600">{livro.autor}</td>
