    ...
    useEffect(() => {
        const buscarLivros = async () => {
            try {
                ...
                alert("Erro ao criar a listagem de livro.");
            }
        }
                        ...
                        <tbody className="divide-y divide-slate-200">
                            {currentLivros && currentLivros.length > 0 ? (
                                currentLivros.map((livro) => (
                                    <tr className="text-center md:text-left transition-colors hover:bg-slate-50 group" key={livro.titulo}>
                                        <td className="p-3 md:p-4 hidden md:table-cell text-slate-500">{livro.id_livro}</td>
                                        <td className="p-3 md:p-4 font-medium text-slate-700">{livro.autor}</td>
                                        <td className="p-3 md:p-4 text-slate-700 font-semibold">{livro.titulo} {livro.ano_publicacao}</td>
